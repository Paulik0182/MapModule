...
import com.paulik.mapmodule.delegates.SharedPreferencesDelegate
...
class IMapFragmentRepoImpl : IMapFragmentRepo {
    ...
    override fun draggedMarker(arg0: Marker, titleMarker: String?) {
        titleMarker?.let {
